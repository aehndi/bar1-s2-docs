...
**1️⃣ Start and Teleport**

* We start **at a random position on the map**. This is **NOT** our final location.
* There are **only a very limited number of free teleports**.
* **Please do NOT teleport immediately.**
* We will clearly inform you **when** and **where** we move as an alliance.

👉 Treat the **free teleport** as if there is **only one**.

---

**2️⃣ Furnace and Resistance have highest priority**
